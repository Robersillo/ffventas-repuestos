        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="top_left_cont intro zoomIn wow animated">
                <center>
                <div>
                <a href="index.php"><img class="logo" id="logo" src="faviconblanco.png" alt="logo"></a>
                    </div>
            </center>
                <br/>
      ...
      <div class="navbar-header">
	    ...
	    <div id="main-nav" class="collapse navbar-collapse navStyle">
			<ul class="nav navbar-nav" id="mainNav">
			  ...
			  <li><a href="Repuestos.html" class="scroll-link">Imagenes</a></li>
    ...
    <div class="client_logos"><!--client_logos-->
        <div class="container">
            <ul class="fadeInRight animated wow">
                <li><a href="javascript:void(0)"><img src="img/ford.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/chevrolet.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/toyota.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/renault.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/fiat.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/mitsubishi.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/chrysler.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/honda.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/jeep.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/dodge.png" alt=""></a></li>
                <li><a href="javascript:void(0)"><img src="img/hyundai.png" alt=""></a></li>
            </ul>
        </div>
    </div>
</section>
